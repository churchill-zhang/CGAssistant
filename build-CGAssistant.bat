...
if not exist "release\CGAssistant.exe" (
    echo CGAssistant\release\CGAssistant.exe was not generated.
    exit /b 1
)

if not exist "..\build" mkdir "..\build"
copy /Y "release\CGAssistant.exe" "..\build\CGAssistant.exe" >nul
if errorlevel 1 exit /b %errorlevel%
